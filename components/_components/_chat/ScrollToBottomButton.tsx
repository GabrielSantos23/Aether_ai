          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                ...
                className="group flex items-center gap-1.5 rounded-full bg-sidebar/80 backdrop-blur-lg shadow-lg dark:shadow-2xl ring-1 ring-black/5 dark:ring-white/10 hover:bg-white/95 dark:hover:bg-[oklch(0.18_0.015_25)]/70 transition-all duration-150 ease-[0.25,1,0.5,1] px-3.5 py-2"
              >
