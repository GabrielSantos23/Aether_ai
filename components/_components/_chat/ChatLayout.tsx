...
import { useChatLayout } from "@/app/hooks/useChatLayout";
...
import { Sidebar } from "../_settings/Sidebar";
...
export default function ChatLayout({
  ...
  const { isAuthenticated, loading, userMetadata } = useAuthContext();
  useFont();

  const [renamingChatInfo, setRenamingChatInfo] = useState<{
    id: string;
    title: string;
  } | null>(null);
  ...
  return (
    <div className="flex h-screen bg-background ">
      ...
      <Dialog
        open={!!sharingChatId}
        onOpenChange={(open) => !open && setSharingChatId(null)}
      >
        <DialogContent>
          <DialogHeader>
