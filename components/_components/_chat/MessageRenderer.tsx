        ...
        {(thinking || (isTyping && !content && modelSupportsThinking)) && (
          <div className="mb-2">
            <button
              ...
              className="flex items-center gap-2 text-left group hover:bg-accent/50 rounded-xl px-2 py-1 transition-colors"
            >
              <span
                className={cn(
            ...
            {!isThinkingCollapsed && thinking && (
              <div className="mt-1 ml-6 pl-3 border-l-2 border-primary/50">
