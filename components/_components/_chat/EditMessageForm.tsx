    ...
    <div className="space-y-2">
      ...
      <div className="flex items-center gap-1 justify-end" data-edit-controls>
        ...
        <button
          ...
          className="p-1.5 text-purple-500/70 hover:text-purple-600 dark:text-purple-300/70 dark:hover:text-purple-300 hover:bg-purple-500/5 dark:hover:bg-purple-300/5 rounded transition-all duration-150 ease-[0.25,1,0.5,1] hover:scale-110 disabled:opacity-50 disabled:cursor-not-allowed"
          title="Save edit"
        >
