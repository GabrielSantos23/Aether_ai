...
export default function AIInput({
  ...
  useEffect(() => {
    if (!isModelAvailable(selectedModel) && availableModels.length > 0) {
      ...
      setSelectedModel(geminiFlashModel || availableModels[0]);
    }
  ...
  const groupedModels = models.reduce(
    (acc, model) => {
      const groupKey = groupBy === "provider" ? model.provider : model.provider;
      if (!acc[groupKey]) {
        acc[groupKey] = [];
      }
  ...
  return (
    <div className="relative">
      <div
        className={cn(
          "relative flex flex-col bg-card/70 backdrop-blur-xl border border-border overflow-visible rounded-2xl shadow-lg transition-all duration-200",
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-transparent via-transparent to-background/20 pointer-events-none rounded-2xl"></div>
              ...
              {attachments.map((attachment, index) => (
                ...
                >
                  ...
                  <div className="flex flex-col min-w-0">
                    <span className="text-foreground truncate max-w-[120px] text-xs font-medium">
                      {attachment.name}
                    </span>
            ...
            <div className="flex items-center gap-1 md:gap-2">
                  ...
                  <div className="flex items-center gap-1 md:gap-1.5">
                    <div
                      className={cn(
                        ...
                        getVendorColor(
                          mounted ? selectedModel.provider : models[0].provider
                        )
                      )}
                    ></div>
                ...
                <AnimatePresence>
                  {showModelSelect && (
                    <motion.div
                      ...
                      className="absolute z-50 bottom-full mb-2 left-0 bg-card rounded-lg border border-border shadow-2xl overflow-hidden w-[280px]"
                    >
                      {/* Header */}
                      <div className="p-3 border-b border-border">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <button className="group relative p-2 rounded-xl bg-card/70 backdrop-blur-xl border border-border hover:border-primary/20 transition-all duration-300 ease-out shadow-lg hover:shadow-xl">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-transparent via-transparent to-background/20 pointer-events-none rounded-xl"></div>
                        ...
                        <div className="flex items-center justify-between gap-3">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            >
                              <div
                                className={cn(
                                  "absolute top-0.5 left-0.5 w-3 h-3 bg-background rounded-full transition-transform duration-200",
                                  thinkingEnabled
                                    ? "translate-x-4"
                                    : "translate-x-0"
                                )}
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              ...
                              className="text-xs px-2 py-1 rounded-md bg-muted text-muted-foreground hover:bg-muted/80 hover:text-foreground transition-colors duration-200 w-16 text-center"
                            >
              ...
              {isSignedIn && selectedModel.features.includes("imagegen") && (
                <button
                  ...
                  className={cn(
                    "w-7 h-7 md:w-8 md:h-8 text-muted-foreground hover:text-foreground transition-all duration-200 rounded-md bg-muted/50 hover:bg-muted flex items-center justify-center",
                    imageGenEnabled && "bg-primary/10 text-primary"
                  )}
                >
            ...
            <div className="flex items-center gap-1">
                ...
                <TooltipTrigger asChild>
                  <button
                    ...
                    className={cn(
                      ...
                      isListening
                        ? "text-primary shadow-md scale-100 hover:bg-primary/5 animate-pulse"
                        : "text-muted-foreground hover:text-primary scale-95 hover:bg-muted hover:scale-100"
                    )}
                  >
              ...
              {isStreaming ? (
                <button
                  ...
                  className="p-2 md:p-2.5 transition-all duration-300 rounded-full text-primary hover:shadow-md scale-100"
                >
                ...
                <button
                  ...
                  className={cn(
                    "group p-2 md:p-2.5 transition-all duration-300 rounded-full",
                    "text-primary shadow-md scale-100 hover:bg-primary/5"
                  )}
                >
                  <ArrowRight
                    className={cn(
                  ...
                  <TooltipTrigger asChild>
                    <button
                      ...
                      className={cn(
                        "group p-2 md:p-2.5 transition-all duration-300 rounded-full",
                        onVoiceChatToggle
                          ? "text-primary shadow-md scale-100 hover:bg-primary/5 cursor-pointer"
                          : "text-muted-foreground scale-95 cursor-not-allowed"
                      )}
                    >
