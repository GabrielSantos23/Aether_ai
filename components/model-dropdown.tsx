    ...
    <div className={cn("relative z-50", className)}>
      ...
      <AnimatePresence>
        <motion.div
          ...
          className={cn(
            "absolute left-0 bg-white dark:bg-[oklch(0.18_0.015_25)] rounded-lg border border-zinc-200/50 dark:border-zinc-700/50 shadow-2xl overflow-hidden w-[320px]",
        ...
        >
          ...
          >
            ...
            <button
              ...
              className="group w-full p-2 cursor-pointer transition-all duration-150 ease-[0.25,1,0.5,1] relative overflow-hidden text-left rounded-md flex items-center justify-between border-b border-zinc-200/30 dark:border-zinc-700/30 mb-2"
            >
              ...
              <button
                ...
                className={cn(
                  ...
                  selectedModel.id === model.id
                    ...
                    : "hover:text-zinc-900 dark:hover:text-zinc-100 text-zinc-600 dark:text-zinc-400"
                )}
              >
                {selectedModel.id === model.id && (
                  <motion.div
                    layoutId="model-highlight"
                    className="absolute inset-0 bg-gradient-to-r from-transparent via-zinc-500/10 dark:via-zinc-400/10 to-transparent"
                  />
                )}
                <div className="flex items-center gap-2 min-w-0 flex-1 relative z-10">
                  <div
                  ...
                  {model.features.includes("web") && (
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <span className="text-xs text-zinc-500 dark:text-zinc-400 px-1 py-0.5 rounded-full">
